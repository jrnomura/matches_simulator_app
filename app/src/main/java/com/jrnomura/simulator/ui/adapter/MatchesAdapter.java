package com.jrnomura.simulator.ui.adapter;
...
import com.jrnomura.simulator.databinding.MatchItemBinding;
import com.jrnomura.simulator.domain.Match;
import com.jrnomura.simulator.ui.DetailActivity;
...
public class MatchesAdapter extends RecyclerView.Adapter<MatchesAdapter.ViewHolder>{
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        holder.itemView.setOnClickListener(view -> {
            ...
            intent.putExtra(DetailActivity.Extras.MATH, match);
